Here is the [link](https://github.com/SamanthaHGerber/practicalapplication3/blob/main/prompt_III.ipynb) to the code accompanied with graphs, models, and analysis. 
